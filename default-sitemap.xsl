...
>
	...
	<div id="content-head">
		...
		<xsl:choose>
			<xsl:when test="$fileType='RSS'">
				<p>Generado por <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=liteplugin&#038;utm_medium=xml-sitemap" target="_blank" rel="noreferrer noopener">All in One SEO</a>, este es un mapa del sitio RSS, pensado para ser consumido por motores de búsqueda como Google o Bing.</p>
				<p>
					Puedes encontrar más información acerca de los mapas del sitio RSS en <a href="https://www.sitemaps.org/" target="_blank" rel="noreferrer noopener">sitemaps.org</a>.				</p>
			</xsl:when>
			<xsl:otherwise>
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				y se generó el octubre 10, 2024 a las 7:01 pm			</p>
		</xsl:if>
	</div>
</xsl:template>
	...
	<a href="/"><span>Hogar</span></a>
		...
		<div class="empty-sitemap__buttons">
			<a href="/" class="button">Volver a la página de inicio</a>
					</div>
